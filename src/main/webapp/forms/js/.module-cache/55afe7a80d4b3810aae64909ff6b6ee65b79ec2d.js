        ...
        return (
          React.createElement("tr", {key: "0", className: headerRowClassName}, 
              header.map(
                  ...
                  return (
                  React.createElement("td", {key: index, onMouseOver: onMouseOver.bind(this), onMouseOut: onMouseOut.bind(this), className: headerColumnClassName}, 
                  React.createElement("span", {className: "float-left display-inline"}, '\u25c0'), React.createElement("span", {className: "display-inline"}, col), React.createElement("span", {className: "float-right display-inline"}, '\u25b2 \u25bc \u25b6')
                  )
                  );
                  }
              )
