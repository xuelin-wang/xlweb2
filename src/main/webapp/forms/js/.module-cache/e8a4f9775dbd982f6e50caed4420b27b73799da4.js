        ...
        return (
          React.createElement("tr", {key: "0", className: headerRowClassName}, 
              header.map(
                  ...
                  React.createElement("span", {className: "float-left inline-block"}, '\u25c0'), React.createElement("span", {className: "inline-block"}, col), React.createElement("span", {className: "float-right inline-block"}, '\u25b2 \u25bc \u25b6')
                  )
                  );
                  }
              )
