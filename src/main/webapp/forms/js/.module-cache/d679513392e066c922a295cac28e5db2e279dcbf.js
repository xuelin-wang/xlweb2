  ...
  render: function() {
    ...
    var defaultTableHeaderRowRenderer = function(props) {
        ...
        var onMouseOver = function(event) {
            React.findDOMNode(this.refs.theLeftSpan).style.display='inline';
            React.findDOMNode(this.refs.theRightSpan).style.display='inline';
        };
        var onMouseOut = function(event) {
            React.findDOMNode(this.refs.theLeftSpan).style.display='none';
            React.findDOMNode(this.refs.theRightSpan).style.display='none';
        };
        ...
        return (
          React.createElement("tr", {key: "0", className: headerRowClassName}, 
              header.map(
                  ...
                  return (
                  React.createElement("td", {key: index, onMouseOver: onMouseOver, onMouseOut: onMouseOut, className: headerColumnClassName}, 
                  React.createElement("span", {ref: "theLeftSpan", className: "float-left display-inline"}, '\u25c0'), React.createElement("span", {className: "display-inline"}, col), React.createElement("span", {ref: "theRightSpan", className: "float-right display-inline"}, '\u25b2 \u25bc \u25b6')
                  )
                  );
                  }
              )
