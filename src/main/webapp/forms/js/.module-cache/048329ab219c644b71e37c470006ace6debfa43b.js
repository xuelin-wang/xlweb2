        ...
        return (
          React.createElement("tr", {key: "0", className: headerRowClassName}, 
              header.map(
                  ...
                  React.createElement("span", {className: leftSpanClassNames}, '\u25c0'), React.createElement("span", {className: "display-inline"}, col), React.createElement("span", {className: rightSpanClassNames}, '\u25b2 \u25bc \u25b6')
                  )
                  );
                  }
              )
